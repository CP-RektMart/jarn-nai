    ...
    <div className="h-40 w-full bg-primary flex flex-col mt-auto">
      <div className="container max-w-6xl flex h-full w-full mx-auto justify-center items-center">
        <div className="text-white text-sm flex flex-col gap-4">
          <span className="text-2xl text-center">(อา)จารย์ ไหน</span>
          <div className="flex justify-center items-end gap-2">
            <span className="text-xl">CP-Rektmart.</span>
            <span className="text-xl">|</span>
            <a
              href="https://github.com/CP-RektMart/jarn-nai"
              className="flex flex-row justify-center items-center gap-2"
            >
              <span className="text-xl">Open Source on</span>
              <svg
          ...
          <div className="flex justify-center items-end">
            <a href="#privacy" className="text-white hover:text-gray-300 mr-4">
              Privacy Policy
            </a>
